...
class ValeurConsolidee:
    ...
    def show_tab(self):
        ...
        if submit_valeur_consolidee_button:
            ...
            query = "UPDATE KPI_GIM_DEBIT_POINTE SET KPI_GIM_DEBIT_POINTE.VALEUR_CONSOLIDEE=TEMPORARY_VALEUR_CONSOLIDEE.VALEUR_CONSOLIDEE, KPI_GIM_DEBIT_POINTE.COMMENTAIRE=TEMPORARY_VALEUR_CONSOLIDEE.COMMENTAIRE FROM TEMPORARY_VALEUR_CONSOLIDEE WHERE KPI_GIM_DEBIT_POINTE.JOURNEE=TEMPORARY_VALEUR_CONSOLIDEE.JOURNEE AND KPI_GIM_DEBIT_POINTE.SITE=TEMPORARY_VALEUR_CONSOLIDEE.SITE AND KPI_GIM_DEBIT_POINTE.COMBUSTIBLE=TEMPORARY_VALEUR_CONSOLIDEE.COMBUSTIBLE"
