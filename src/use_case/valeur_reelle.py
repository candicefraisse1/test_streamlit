...
class ValeurReelle:
    ...
    def show_tab(self):
        ...
        if submit_valeur_reelle_button:
            ...
            query = "UPDATE KPI_GIM_DEBIT_POINTE SET KPI_GIM_DEBIT_POINTE.VALEUR_REELLE=TEMPORARY_VALEUR_REELLE.VALEUR_REELLE, KPI_GIM_DEBIT_POINTE.VALEUR_CONSOLIDEE=TEMPORARY_VALEUR_REELLE.VALEUR_CONSOLIDEE, KPI_GIM_DEBIT_POINTE.COMMENTAIRE=TEMPORARY_VALEUR_REELLE.COMMENTAIRE FROM TEMPORARY_VALEUR_REELLE WHERE KPI_GIM_DEBIT_POINTE.JOURNEE=TEMPORARY_VALEUR_REELLE.JOURNEE AND KPI_GIM_DEBIT_POINTE.SITE=TEMPORARY_VALEUR_REELLE.SITE AND KPI_GIM_DEBIT_POINTE.COMBUSTIBLE=TEMPORARY_VALEUR_REELLE.COMBUSTIBLE"
